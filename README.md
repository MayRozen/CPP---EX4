...
# סיכום
בנוסף לכלל הכתוב לעיל, קיימות הערות רבות נוספות בקוד עצמו הנוגעות במימוש הפרטים וביצוע הבדיקות.
כמן כן, על מנת לצייר את העץ השתמשתי בsfml הממומשת בתוך מחלקת Tree ונקראת על ידי tree.drow().
